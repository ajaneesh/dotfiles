...
(defun my/apply-fonts-and-faces ()
  ...
  (with-eval-after-load 'mu4e
    (custom-theme-set-faces
     'user
     `(mu4e-header-face ((t (:family ,variable-font :height 80))))
     `(mu4e-header-title-face ((t (:family ,variable-font :height 80))))
     `(mu4e-header-key-face ((t (:family ,variable-font :height 80))))
     `(mu4e-header-value-face ((t (:family ,variable-font :height 80))))
     `(mu4e-contact-face ((t (:family ,variable-font :height 80))))
